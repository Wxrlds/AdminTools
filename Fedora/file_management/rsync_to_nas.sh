...
# Pictures
rsync -av --progress /mnt/local/pictures user@192.168.178.60::pictures/User/

# https://askubuntu.com/questions/476041/how-do-i-make-rsync-delete-files-that-have-been-deleted-from-the-source-folder
# Documents
rsync -av --progress --delete-before /mnt/local/documents user@192.168.178.60::homes/User/documents